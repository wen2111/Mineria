...
cm_cv
```
El modelo kNN obtuve la exactitud global (Accuracy) del 80,76%, 
...
- Se puede ver que la Sensibilidad = 0,1448, muestra que el modelo solo ha podido identificar correctamente un 14,02% de los clientes que abandonan. La gran mayoría de los casos no han sido detectados.
- Debido el sesgo habia la clase mayoritaria "No", la Especificidad es muy alta,  un  98,19%.
- La precisión positiva (Pos Pred Value) es 0,6703 indica que de todos los clientes que el modelo predice como "Yes"alrededor del 67,03% realmente abandonaron.
El índice Kappa es 0,1726 confirma que el acuerdo del modelo con las etiquetas reales es solo ligeramente meor que el azar. Es muy bajo para ser un modelo robusto.
