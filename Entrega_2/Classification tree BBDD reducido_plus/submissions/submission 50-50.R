...
data_balanced <- ROSE(Exited ~ ., data = datatrainfull, p = 0.5, seed = 123)$data
...
# Guardar en Excel
write.csv(resultado_final, "~/GitHub/Mineria/Entrega_2/Classification tree BBDD reducido_plus/submit_reducida_plus_balance50.csv", row.names = FALSE)
