...
## A partir de aquí, usar train2_x en lugar de train2:
...
# manualmente probar varios umbrales y ver métricas
...
## Extraer mejor grid y entrenar modelo final en TODO el train (7000 obs)

best_grid <- fit_xgb$bestTune   # <-- AQUÍ es donde te faltaba

# Hacemos dummies sobre TODO el train usando el MISMO dmy
...
# IMPORTANTÍSIMO: usamos el MISMO dmy
test_full_x <- as.data.frame(predict(dmy, newdata = test))
# OJO: para Kaggle normalmente test NO tiene Exited; 
# si lo tiene solo para validar, puedes guardarlo igual:
...
## 7. Crear submission
# Asegúrate de que 'data' o 'data_reducida_plus' tiene la columna ID.
# Si la ID está en data_reducida_plus:
